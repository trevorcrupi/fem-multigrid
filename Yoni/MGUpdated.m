function solution = MGUpdated(inputUVector,globalB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights)
...
%         numOfMGIterations    = numOfMGIterations +1;
        ...
        if meshNum == 1 %Base case - ends recursion.
            ...
            P          = prolongUpdated(meshNum-1);
            newGlobalB = P'*(globalB - storingA{meshNum} * V1);
%                                 MG(inputUVector,globalB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights)
            V2         = V1 + P * MGUpdated( zeroVector, newGlobalB, meshNum-1, storingA, storingEdge, storeNodeNums, storeHeights);
