function [c,globalA,height,numOfNodes,MGErrorConvergenceRate,numOfMGIterations] = solveApproximationForMultigridParallelogram(p,e,t,numOfTriangles,k,edge,meshNum,storingA,storingEdge,storeNodeNums,storeHeights)
...
% For "With Multigrid": storingA, storingEdge, storeNodeNums,storeHeights as extra function inputs.
    ...
    meshNum;
    mystr = ['parallelogram/new_ele' num2str(meshNum) '.mat'];
    load(mystr);
...
%     c = MG(inputUVector,testB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights);
    [c,MGErrorConvergenceRate,numOfMGIterations] = MGMainParallelogram(inputUVector,testB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights);
