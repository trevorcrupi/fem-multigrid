function [solution,MGErrorConvergenceRate,numOfMGIterations] = MGMainLShapeD(inputUVector,globalB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights)
...
%                more function outputs.
    ...
    while checkForToleranceMG >= (10^(-15))             % This condition for "Test MG".
        ...
        solution_i = MGLShapeD( solution_i, globalB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights);
