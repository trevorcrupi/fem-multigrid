function [solution,MGErrorConvergenceRate,numOfMGIterations] = MGMainParallelogram(inputUVector,globalB, meshNum, storingA, storingEdge, storeNodeNums,storeHeights)
